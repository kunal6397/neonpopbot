...
__repo__ = "https://github.com/rickakhtar07/Popcorn---BOT.git"
__version__ = "POPCORN--BOT ᴠ1.0.0"
__license__ = "GNU GENERAL PUBLIC LICENSE V2"
__copyright__ = "Copyright (C) 2023-present ₹ Ɨ € Ԟ <https://github.com/rickakhtar07>"
